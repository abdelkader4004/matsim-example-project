...
package org.matsim.MyTaxi.taxi.scheduler;
...
public class TaxiScheduler implements MobsimBeforeCleanupListener {
	...
	public void scheduleRequest(DvrpVehicle vehicle, TaxiRequest request, VrpPathWithTravelData vrpPath) {
		if (request.getStatus() != TaxiRequest.TaxiRequestStatus.UNPLANNED) {
	...
	/**
	 * Awaiting == unpicked-up, i.e. requests with status PLANNED or TAXI_DISPATCHED See {@link TaxiRequest.TaxiRequestStatus}
	 */
