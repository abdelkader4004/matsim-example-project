...
public class RunOneTaxiOneTruckExample {
    ...
    public static void main(String args[]) throws URISyntaxException, MalformedURLException {
        ...
        new RunOneTaxiOneTruckExample().run(new URI("file:///C:/Users/abd/IdeaProjects/matsim-example-project/examples/dvrp-grid/one_taxi_one_truck_config.xml").toURL(),
                "one_taxi_vehicles.xml",
                "one_truck_vehicles.xml",false,0);
    }
