...
public final class TwoTrucksRequestCreator implements MobsimAfterSimStepListener {
	...
	@Inject
	public TwoTrucksRequestCreator(@DvrpMode(TransportMode.truck) VrpOptimizer optimizer,
	...
	private TwoTrucksRequest createRequest(String requestId, String fromLinkId, String toLinkId, double time,
                                                                                    Network network) {
		return new TwoTrucksRequest(Id.create(requestId, Request.class),
	...
	private boolean isReadyForSubmission(TwoTrucksRequest request, double currentTime) {
