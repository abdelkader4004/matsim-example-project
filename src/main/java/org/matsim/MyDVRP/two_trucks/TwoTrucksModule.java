 ...
 */
public class TwoTrucksModule extends AbstractDvrpModeModule {
	private final URL fleetSpecificationUrl;

	public TwoTrucksModule(URL fleetSpecificationUrl) {
	...
	public void install() {
		...
		installQSimModule(new AbstractDvrpModeQSimModule(getMode()) {
			...
			protected void configureQSim() {
				...
				addModalComponent(TwoTrucksRequestCreator.class);
				bindModal(VrpOptimizer.class).to(TwoTrucksOptimizer.class).asEagerSingleton();
				bindModal(VrpAgentLogic.DynActionCreator.class).to(TwoTrucksActionCreator.class).asEagerSingleton();
			}
		});
	}
