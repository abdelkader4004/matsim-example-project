 ...
 * @author michalm
 */
final class TwoTrucksActionCreator implements VrpAgentLogic.DynActionCreator {
	private final MobsimTimer timer;

	@Inject
	public TwoTrucksActionCreator(MobsimTimer timer) {
		this.timer = timer;
	}
	...
	public DynAction createAction(DynAgent dynAgent, DvrpVehicle vehicle, double now) {
		...
		switch ((TwoTrucksOptimizer.TwoTrucksTaskType)task.getTaskType()) {
			case EMPTY_DRIVE:
			case LOADED_DRIVE:
