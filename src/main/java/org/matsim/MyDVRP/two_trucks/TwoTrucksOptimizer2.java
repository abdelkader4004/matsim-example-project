...
// * @author michalm
// */
//final class TwoTrucksOptimizer2 implements VrpOptimizer {
...
//
//	@Inject
//	public TwoTrucksOptimizer2(@DvrpMode(TransportMode.truck) Network network, @DvrpMode(TransportMode.truck) Fleet fleet,
//                               MobsimTimer timer) {
//		this.timer = timer;
...
//		}
////		double TwoTrucksOptimizer = schedule1.getStatus() == ScheduleStatus.UNPLANNED ?
