...
public final class OneTruckRequestCreator implements MobsimAfterSimStepListener {
	...
	private final PriorityQueue<org.matsim.contrib.dvrp.examples.onetruck.OneTruckRequest> requests = new PriorityQueue<>(10,
	...
	private org.matsim.contrib.dvrp.examples.onetruck.OneTruckRequest createRequest(String requestId, String fromLinkId, String toLinkId, double time,
                                                                                    Network network) {
		return new org.matsim.contrib.dvrp.examples.onetruck.OneTruckRequest(Id.create(requestId, Request.class),
